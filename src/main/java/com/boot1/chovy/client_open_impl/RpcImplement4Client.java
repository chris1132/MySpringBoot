package com.boot1.chovy.client_open_impl;
...
public class RpcImplement4Client {
    ...
    private final RpcClient rpcClient = new RpcClient(new ServiceDiscovery("127.0.0.1:2181"));

    private long timeOut = 5000L;

    private TimeUnit timeOutUnit = TimeUnit.MILLISECONDS;

    public Object client4Sync(){
        return null;
    }


    public Object client4Async(String className,String funcName, Object... args)throws Exception{
        IAsyncObjectProxy iAsyncObjectProxy = rpcClient.createAsync();
